...
<body>
    <div class="container my-5">
        ...
        <form method="POST" action="update_user.php">
            ...
            <input class="form-control" type="text" name="fname" value="<?php echo ((array)json_decode($_SESSION['user_data']))['fname'] ?? '' ?>">
            <label class="form-label" for="lname">Last Name</label>
            <input class="form-control" type="text" name="lname" value="<?php echo ((array)json_decode($_SESSION['user_data']))['lname'] ?? '' ?>">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="username" value="<?php echo ((array)json_decode($_SESSION['user_data']))['username'] ?? '' ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="department" value="<?php echo ((array)json_decode($_SESSION['user_data']))['department'] ?? '' ?>">
            </div>
            <div class="mb-3">
                <label class="form-label" for="code">Code</label>
                <input class="form-control" type="text" name="code" value="<?php echo ((array)json_decode($_SESSION['user_data']))['code'] ?? '' ?>">
            </div>
            <div class="mb-3">
